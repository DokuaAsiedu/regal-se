<div class="flex flex-col gap-5">
    ...
    <form wire:submit="save" class="grid lg:grid-cols-2 gap-6">
        <div class="flex flex-col gap-2">
            <label for="name">Name <x-required /></label>
        ...
        <div class="flex flex-col gap-2">
            <label for="cost_price">Cost Price <x-required /></label>
        ...
        <div class="flex flex-col gap-2">
            <label for="quantity">Quantity <x-required /></label>
        ...
        <div class="flex flex-col gap-2">
            <label for="status">Status <x-required /></label>
